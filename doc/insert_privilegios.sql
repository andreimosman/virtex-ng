...
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (1, '_CLIENTES', 'Clientes', true, true, 'Pesquisa/Visualização de Clientes', 'Cadastro/Alteração de Clientes');
...
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (11, '_COBRANCA_BLOQUEIOS', 'Cobranca::Bloqueios', true, true, 'Visualização dos Clientes Passíveis de Bloqueio', 'Execução dos bloqueios em clientes passíveis de bloqueio');
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (12, '_COBRANCA_AMORTIZACAO', 'Cobranca::Amortização', false, true, NULL, 'Amortização de Faturas');
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (13, '_COBRANCA_GERAR_BOLETOS', 'Cobranca::Gerar Cobrança/Boletos', false, true, NULL, 'Gerar lotes de cobrança/boletos');
...
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (15, '_COBRANCA_RELATORIOS', 'Cobranca::Relatórios', true, true, 'Visualização dos Relatórios de Cobrança', NULL);
...
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (22, '_CONFIGURACOES_EQUIPAMENTOS', 'Configurações::Equipamentos', true, true, 'Visualização das Informações dos Equipamentos', 'Cadastro/Alteração dos dados de equipamentos');
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (23, '_CONFIGURACOES_PREFERENCIAS', 'Configurações::Preferências', true, true, 'Visualização das Preferências', 'Alteração das Preferências');
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (24, '_CONFIGURACOES_PREFERENCIAS_REGISTRO', 'Configurações::Preferências::Registro do Software', true, true, 'Visualização do Registro do Software', 'Upload do Arquivo de Licença');
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (25, '_CONFIGURACOES_RELATORIOS', 'Configurações::Relatórios', true, false, 'Visualização dos Relatórios de Configurações', NULL);
INSERT INTO adtb_privilegio (id_priv, cod_priv, nome, tem_leitura, tem_gravacao, descricao_leitura, descricao_gravacao) VALUES (26, '_ADMINISTRACAO_ADMINISTRADORES', 'Administração::Administradores', true, true, 'Visualização dos Administradores', 'Cadastro/Alteração dos Administradores e seus Privilégios');
