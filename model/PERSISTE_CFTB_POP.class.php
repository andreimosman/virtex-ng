	...
	class PERSISTE_CFTB_POP extends VirtexPersiste {
		...
		public function __construct() {
			...
			$this->_campos		= array("id_pop","nome","info","tipo","id_pop_ap","status","ipaddr","snmp_rw_com","infoserver",
										"snmp_versao", "snmp_ro_com", "ativar_snmp", "ativar_monitoramento","id_servidor", "macaddr", "bloquearmac", "clientemacpop", "mac", "usa_mac_ap");
			$this->_chave 		= "id_pop";
			...
			$this->_filtros		= array("id_pop_ap" => "custom", "status" => "custom", "ativar_snmp" => "bool",
										"ativar_monitoramento" => "bool", "bloqueramac" => "bool", "clientemacpop" => "bool", "usa_mac_ap" => "bool");
